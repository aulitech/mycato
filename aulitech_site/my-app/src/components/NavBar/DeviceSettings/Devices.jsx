...
const Dropdown = ({ value, onChange, title, description, options }) => {
  ...
  return (
    <div className="flex w-fit flex-col align-center justify-space-between">
      <div className="flex flex-row w-fit align-center justify-left group relative">
        <label
        ...
        <select className='bg-slate-300 text-xs hover:text-sm hover:font-bold hover:italic hover:bg-slate-600 hover:text-yellow-400 flex w-fit appearance-none focus:outline-none'
      ...
      const ConnectionAccordion = ({ connection, onDelete, makePrimary, index }) => {
        ...
        const ConnectionSpecificSettings = () => {
          ...
          return (
            ...
            <details open >
              <summary className='font-small font-bold pb-2'>Screen Size
              </summary>
              <div className='flex w-full flex-row flex-wrap align-items-start'>
                <InputSlider
